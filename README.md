...
-   Terraform (mandatory infrastructure provisioning layer)
...
↓\
Destination Subscription + Backup Reconfiguration
...
## 🏗 Terraform (Mandatory Infrastructure Layer)

Terraform ensures:

-   Required resource groups exist
-   Networking is validated or provisioned
-   Recovery Services Vault is created
-   Backup policies are defined
-   Governance alignment before migration
...
Terraform execution is mandatory before migration phases.
...
Enterprise-grade Azure VM migration automation built using GitHub
